...
import { invert, lerp, inverseLerp, fuzzyEqual } from '../../functions/index.js'
...
export class Vector2 {
   ...
   */
  fuzzyEquals(v) {
    return Vector2.fuzzyEqual(this, v)
  }
   ...
   * @returns { Vector2}
   */
  static inverseLerp(from, to, t, out = new Vector2()) {
    out.x = inverseLerp(from.x, to.x, t)
    out.y = inverseLerp(from.y, to.y, t)
