 ...
 */
export function SAT2d(verticesA, verticesB, axes, positionAB) {
  ...
  return getContacts(verticesA, verticesB, results, position)
}
 ...
 * @param {Affine2} positionAB
 */
export function sat2dCircle(circle, vertices, axes, positionAB) {
  const position = new Vector2(
    positionAB.x,
    positionAB.y
  )
  ...
  return getContacts(verticesA, vertices, results, position)
}
